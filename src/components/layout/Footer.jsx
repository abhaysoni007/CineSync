  ...
  return (
    <footer className="bg-gray-950 border-t border-gray-900">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Watch movies together in perfect sync, no matter where you are in the world.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-400 hover:text-primary-500 transition">Sync Technology</a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-primary-500 transition">Chat & Reactions</a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-primary-500 transition">AI Features</a>
              </li>
              <li>
                <a href="#" className="text-gray-400 hover:text-primary-500 transition">Private Rooms</a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-900 text-center text-gray-500">
